...
function autoFit(){
  ...
  var initParam = getManualParameters();
...
function disableInput(state, objId){
  ...
  var obj = document.getElementById(objId).getElementsByTagName("input");//find inputs
